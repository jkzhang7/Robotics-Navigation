...
class neuralRMP(nn.Module):
    def __init__(self):
        super().__init__()
        self.resnet = torchvision.models.resnet50(pretrained=True)
        self.image_encodeV2 = nn.Linear(1000, 512)
        self.image_encode = ImageEncoderV3(output_dim=512, init_scale=1.0, residual_link=False)
        self.vel_encode = VelocityEncoder(init_scale=1.0)
        self.ang_encode = AngularVelocityEncoder(init_scale=1.0)
        self.goal_encode = WaypointEncoder(init_scale=1.0)
